...
class OrganisationUpdateInvitation extends Mutation
{
    protected $attributes = [
        'description' => 'Update an invitation in an organisation'
    ];
    ...
    public function resolve($root, $args)
    {
        ...
        return $organisation->updateInvitation($invitation, $role);
    }
}

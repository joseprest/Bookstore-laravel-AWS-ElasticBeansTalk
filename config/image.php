...
return array(
    ...
    */
    ...
    |
    */
    'host' => env('CDN_HOST', 'http://cdn.manivelle.io'),
    ...
    */
    ...
    |
    */
    'proxy_route' => 'assets/{image_proxy_pattern}',
    ...
    |
    */
    'proxy_route_pattern' => '^(.*)\.(jpg|jpeg|png|gif|svg|JPG|JPEG|PNG|GIF|SVG)$',
